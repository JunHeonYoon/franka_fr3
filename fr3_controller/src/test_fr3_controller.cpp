#include "fr3_controller/test_fr3_controller.hpp"

#include <unordered_set>

namespace fr3_controller
{
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(fr3_controller::TestFr3Controller, controller_interface::ControllerInterface)
